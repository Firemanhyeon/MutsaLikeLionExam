package org.blog.oauthexam.config;

import lombok.RequiredArgsConstructor;
import org.blog.oauthexam.security.CustomOAuth2AthenticationSuccessHandler;
import org.blog.oauthexam.security.CustomUserDetailsService;
import org.blog.oauthexam.service.SocialUserService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, CustomOAuth2AthenticationSuccessHandler customOAuth2AthenticationSuccessHandler) throws Exception{
        http
                .authorizeRequests(authorize -> authorize
                        .requestMatchers("/userregform","/userreg","/","/loginform","/welcome").permitAll() //아무런 권한이 없어도 접근 가능할 페이지
